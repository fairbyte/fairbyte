...
static const int FIRST_POS_BLOCK = 100000;
static const int MIDDLE_POW_BLOCK = 150000;
...
static const int64_t MAX_MONEY = 135000000 * COIN;
static const double TAXATION_PERCENTAGE = 0.0015;
...
static const uint256 hashGenesisBlock("00000764dbece37706b609ddd78c1ab38446ffcfa187f867cfba85803d158f4e");
static const uint256 hashGenesisBlockTestNet("000004afbbc6d9174ead214290f83d93d381dc0d30d12c0f47394eea9cd8926c");
...
public:
    ...
    {
        // fairbyte: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // fairbyte: get transaction coin age
...
public:
    ...
    // fairbyte: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // fairbyte: two types of block: proof-of-work or proof-of-stake
    ...
    // fairbyte: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // fairbyte: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // fairbyte: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // fairbyte: block index flags
    enum  
    {
