...
QMAKE_CXXFLAGS_WARN_ON = -fdiagnostics-show-option -Wextra -Wno-ignored-qualifiers -Wformat -Wformat-security -Wno-unused-parameter -Wstack-protector
...
macx:ICON = src/qt/res/icons/fairbyte.icns
macx:TARGET = "fairbyte-Qt"
